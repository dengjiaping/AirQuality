...
public class DirectionalViewPager extends ViewPager {
    ...
    void populate() {
        ...
        final int endPos = Math.min(count - 1, mCurItem + pageLimit);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                Log.v(TAG, "primaryDiff:" + primaryDiff + " mTouchSlop:" + mTouchSlop + " secondaryDiff:" + secondaryDiff);
                Log.v(TAG, "yDiff:" + y + " mLastMotionY:" + mLastMotionY + "pointerIndex:" + pointerIndex + "activePointerId:" + activePointerId);
                if (primaryDiff > (mTouchSlop * 5 / 2) && primaryDiff > secondaryDiff) {
                    if (DEBUG) Log.v(TAG, "Starting drag!");
                    Log.v(TAG, "mIsBeingDragged:" + "改变值1");
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mScrollState == SCROLL_STATE_SETTLING) {
                    ...
                    Log.v(TAG, "mIsBeingDragged:" + "改变值2");
                    mIsBeingDragged = true;
                    mIsUnableToDrag = false;
                    setScrollState(SCROLL_STATE_DRAGGING);
                } else {
        ...
        */
        if (DEBUG)
            Log.v(TAG, "mIsBeingDragged:" + mIsBeingDragged);
