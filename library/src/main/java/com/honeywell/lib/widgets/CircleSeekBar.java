...
//        setLayoutTextView();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mViewWidth = getWidth() - mTextWidth * 3 / 2;
        mViewHeight = getHeight() - mTextWidth * 3 / 2;
...
//                mSeekBarDegree = 0;
    ...
    private void setCursorPositon(double radian) {
        ...
        double Y = mSeekBarCenterY + (mSeekBarRadius + mDelta) * Math.sin(radian) + mTextHeight / 2;
        mPointLeft = (float) (X);
        mPointTop = (float) (Y);
    }
