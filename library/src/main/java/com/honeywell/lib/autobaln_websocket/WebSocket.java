...
public interface WebSocket {
    ...
    public void connect(URI uri, ConnectionHandler observer) throws WebSocketException;

    public void connect(URI uri, ConnectionHandler observer, WebSocketOptions options) throws WebSocketException;
