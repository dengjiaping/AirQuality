...
package com.honeywell.lib.autobaln_websocket;
...
import com.honeywell.lib.autobaln_websocket.WebSocket.ConnectionHandler.WebSocketCloseNotification;
import com.honeywell.lib.autobaln_websocket.WebSocketMessage.WebSocketCloseCode;
...
public class WebSocketConnection implements WebSocket {
    ...
    private void onClose(WebSocketCloseNotification code, String reason) {
        ...
        if (webSocketObserver != null) {
            try {
                if (reconnecting) {
                    webSocketObserver.onClose(ConnectionHandler.WebSocketCloseNotification.RECONNECT, reason);
                } else {
