...
public class WebSocketWriter extends Thread {
    ...
    protected void sendFrame(int opcode, boolean fin, byte[] payload, int offset, int length) throws IOException {
        ...
        if (len <= 125) {
            ...
            b1 |= (byte) (127 & 0xff);
            mApplicationBuffer.put(b1);
            mApplicationBuffer.put(new byte[]{(byte) ((len >> 56) & 0xff), (byte) ((len >> 48) & 0xff), (byte) ((len >> 40) & 0xff), (byte) ((len >> 32) & 0xff), (byte) ((len >> 24) & 0xff), (byte) ((len >> 16) & 0xff), (byte) ((len >> 8) & 0xff), (byte) (len & 0xff)});
        }
