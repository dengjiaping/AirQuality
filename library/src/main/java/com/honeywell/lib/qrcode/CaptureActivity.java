package com.honeywell.lib.qrcode;
...
import com.honeywell.lib.qrcode.Listener.FinishListener;
import com.honeywell.lib.qrcode.Manager.BeepManager;
import com.honeywell.lib.qrcode.Manager.CameraManager;
import com.honeywell.lib.qrcode.handler.CaptureActivityHandler;
import com.honeywell.lib.qrcode.widgets.ViewfinderView;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    private void initComponent() {
        ...
        mCurrentState = mSharedPreferences.getString(CURRENT_STATE, "qrcode");
        cameraManager = new CameraManager(getApplication());
        Intent intent = getIntent();
        mCaptureType = intent.getIntExtra(CAPTURE_TYPE, 0);
    }
...
//        statusView = (TextView) findViewById(R.id.status_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && data.getBooleanExtra("finish_all", false)) {
        ...
        if ("success".equals(result)) {
            ...
            if (!scanUIItem.isCorrect) {
                ToastUtil.showShort(CaptureActivity.this, R.string.invalid_result);
                return;
            }
            ...
            bundle.putInt(CAPTURE_TYPE, mCaptureType);
...
//        statusView.setVisibility(View.GONE);
    ...
    private void saveScanTypeToSp() {
        ...
        localEditor.putString(CURRENT_STATE, mCurrentState);
        localEditor.commit();
    }
