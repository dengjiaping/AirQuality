...
public class MySSLSocketFactory extends SSLSocketFactory {
    ...
    public Socket createSocket(Socket socket, String host, int port, boolean autoClose) throws IOException {
        Socket socket01 = sslContext.getSocketFactory().createSocket(socket, host, port, autoClose);
     ...
     */
    private void enableSecureProtocols(Socket socket) throws IOException {
        // get supported params
        SSLParameters params = sslContext.getSupportedSSLParameters();
        String[] supportedProtocols = params.getProtocols();

        // activate supported protocols on the socket
        Socket socket01 = sslContext.getSocketFactory().createSocket();
