package com.honeywell.iaq.chart.view;
...
import com.honeywell.iaq.chart.model.Point;
...
public class LineChartView extends View {
    ...
    public static  float[] HOHC_Y_VALUES = {25, 50, 75};
    public static  int[] CO2_Y_VALUES = {25, 50, 75};
    public static  float[] TVOC_Y_VALUES = {25, 50, 75};
    ...
    public void setHOHCYValues(float[] values){
        HOHC_Y_VALUES = values;
    }

    public float[] getHOHCYValues(){
    ...
    public void setTVOCYValues(float[] values){
        TVOC_Y_VALUES = values;
    }

    public float[] getTVOCYValues(){
