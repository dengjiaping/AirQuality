...
import com.honeywell.Zxing.camera.open.OpenCameraInterface;
...
//  private static  int MAX_FRAME_HEIGHT = 480;
    ...
    public static CameraManager init(Context context) {
        if (cameraManager == null) {
            return cameraManager = new CameraManager(context);
        }
    ...
    public synchronized void openDriver(SurfaceHolder holder) throws IOException {
        ...
        if (theCamera == null) {
            ...
            if (requestedCameraId >= 0) {
                theCamera = OpenCameraInterface.open(Camera.CameraInfo.CAMERA_FACING_BACK);
            } else {
