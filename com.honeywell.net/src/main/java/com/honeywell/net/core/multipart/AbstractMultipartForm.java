...
package com.honeywell.net.core.multipart;
...
import com.honeywell.net.core.multipart.content.ContentBody;
...
abstract class AbstractMultipartForm {
    ...
    private static void writeBytes(final String s, final OutputStream out)
            throws IOException {
        final ByteArrayBuffer b = encode(DEFAULT_CHARSET, s);
        writeBytes(b, out);
    }

    protected static void writeField(final MinimalField field,
            final OutputStream out) throws IOException {
     ...
     * @param charset the character set to use. May be {@code null}, in which case - i.e. US-ASCII - is used.
     * @param boundary to use  - must not be {@code null}
     * @throws IllegalArgumentException if charset is null or boundary is null
     */
    public AbstractMultipartForm(final String subType, final Charset charset,
    ...
    void doWriteTo(final OutputStream out, final boolean writeContent)
            throws IOException {
    ...
    /**
      ...
      */
    protected abstract void formatMultipartHeader(final FormBodyPart part,
            final OutputStream out) throws IOException;
